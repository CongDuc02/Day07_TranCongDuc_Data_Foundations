...
> [!IMPORTANT]
> **Một báo cáo, hai góc nhìn**: Phần nhóm (lựa chọn tài liệu, chiến lược) sẽ giống nhau giữa các thành viên. Phần cá nhân (hướng tiếp cận, kết quả, phản ngẫm) phải khác nhau vì mỗi người lập trình riêng.
